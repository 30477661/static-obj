<template>
    <div class="new-book">
        ...
        <div class="top-search" style="background-color:#fff;">
            <img src="../../../static/index-search-icon.png" alt=""><input type="text" placeholder="题名、著者、分类号、出版社、主题词" style="background-color:#e5e5e5; box-shadow:none;">
        </div>
        <div class="base-information">检索到2条结果</div>
            ...
            <router-link tag="div" :to="{name:'BookDetail',params:{id:2001}}">
                ...
                <ul class="bookimg-rg">
                    ...
                    <li>
                        <span>出版社：</span>
                        <span>湖南文艺出版社</span>
                        <router-link tag="span" :to="{name:'BookDetail',params:{id:10001,tabSwitch:4}}"><img src="../../../static/comment-pen.png" alt=""> <font color="#666666">30</font></router-link>
                    </li>
                </ul>
            </router-link>
        </div>
